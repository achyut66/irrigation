...
export default function Mission (){
    return (
        ...
        <h4 className="text-xl font-semibold text-gray-600 ml-18">१. सामुदायिक–आधारित जल व्यवस्थापन सुदृढ गर्ने</h4>
        ...
        <br/>
        <h4 className="text-xl font-semibold text-gray-600 ml-18">२. सिँचाइ पूर्वाधार विकास र सुधार</h4>
        <ul className="list-disc text-sm font-semibold text-gray-800 ml-24">
        ...
        <h4 className="text-xl font-semibold text-gray-600 ml-18">३. वर्षभर भरपर्दो पानी उपलब्धता सुनिश्चित गर्ने</h4>
        <ul className="list-disc text-sm font-semibold text-gray-800 ml-24">
        ...
        <h4 className="text-xl font-semibold text-gray-600 ml-18">४. कृषि उत्पादनशीलता र किसान आम्दानी वृद्धि</h4>
        <ul className="list-disc text-sm font-semibold text-gray-800 ml-24">
        ...
        <h4 className="text-xl font-semibold text-gray-600 ml-18">५. दिगो र वातावरण–मैत्री जल प्रयोग प्रवर्द्धन</h4>
        <ul className="list-disc text-sm font-semibold text-gray-800 ml-24">
        ...
        <h4 className="text-xl font-semibold text-gray-600 ml-18">१. ज्वालामूखीलाई आदर्श कृषि क्षेत्रका रूपमा स्थापना</h4>
        <ul className="list-disc text-sm font-semibold text-gray-800 ml-24">
          <li>उन्नत सिँचाइ प्रविधि र दिगो कृषि अभ्यासलाई अन्य क्षेत्रले पनि अनुकरण गर्न सकिने गरी प्रवर्द्धन गर्ने।</li>
        </ul>
        <br/>
      
        <h4 className="text-xl font-semibold text-gray-600 ml-18">२. कुशल र न्यायोचित पानी वितरण सुनिश्चित गर्ने</h4>
        <ul className="list-disc text-sm font-semibold text-gray-800 ml-24">
          <li>सबै किसान परिवारलाई समान रूपमा पानी पुर्‍याउने र पानीको अपव्यय रोक्ने प्रणाली विकास गर्ने।</li>
        </ul>
        <br/>
      
        <h4 className="text-xl font-semibold text-gray-600 ml-18">३. जलवायु–सहिष्णु सिँचाइ प्रणाली लागू गर्ने</h4>
        <ul className="list-disc text-sm font-semibold text-gray-800 ml-24">
          <li>जलवायु परिर्वतन, पानी कमी र प्राकृतिक जोखिमलाई सामना गर्न सक्षम प्रविधि र पूर्वाधार निर्माण गर्ने।</li>
        </ul>
        <br/>
      
        <h4 className="text-xl font-semibold text-gray-600 ml-18">४. खाद्य सुरक्षा र दिगो ग्रामीण विकासमा योगदान</h4>
        <ul className="list-disc text-sm font-semibold text-gray-800 ml-24">
        ...
        <h4 className="text-xl font-semibold text-gray-600 ml-18">१. कृषि जमिनमा सिँचाइ पहुँच वृद्धि</h4>
        <ul className="list-disc text-sm font-semibold text-gray-800 ml-24">
        ...
        <h4 className="text-xl font-semibold text-gray-600 ml-18">२. सिँचाइ नहरको पुनर्निर्माण र सुधार</h4>
        <ul className="list-disc text-sm font-semibold text-gray-800 ml-24">
        ...
        <h4 className="text-xl font-semibold text-gray-600 ml-18">३. आधुनिक सिँचाइ प्रविधि प्रवर्द्धन</h4>
        <ul className="list-disc text-sm font-semibold text-gray-800 ml-24">
        ...
        <h4 className="text-xl font-semibold text-gray-600 ml-18">४. जल शासन तथा स्रोत व्यवस्थापन सुधार</h4>
        <ul className="list-disc text-sm font-semibold text-gray-800 ml-24">
