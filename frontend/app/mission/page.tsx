...
export default function Mission (){
    return (
        ...
        <p className="relative text-gray-700 mt-2 mb-6 line-clamp-3 overflow-hidden">
          धादिंगको ज्वालामुखी नगरपालिकामा आधुनिक र सशक्त सिँचाइ संस्कृतिको विकास गर्दै 
        ...
        <p className="relative text-gray-700 mt-2 mb-6 line-clamp-3 overflow-hidden">
          ज्वालामुखी नगरपालिकालाई कुशल पानी वितरण, जलवायु–सहिष्णु सिँचाइ प्रणाली र 
        ...
        <h4 className="text-xl font-semibold text-gray-400 ml-18">१. ज्वालामुखीलाई आदर्श कृषि क्षेत्रका रूपमा स्थापना</h4>
        <ul className="list-disc text-sm font-semibold text-gray-800 ml-24">
