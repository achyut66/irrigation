  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 py-10 px-6 ml-4 md:px-20">
      ...
      <div className="text-left mb-12">
        ...
        <p className="text-gray-700 text-left max-w-7xl mx-auto">
          ज्वालामुखी गाउँपालिकामा सम्पन्न विभिन्न गतिविधि, कार्यक्रम, विकास निर्माण तथा समुदायसँग
          सम्बन्धित महत्वपूर्ण क्षणहरूको फोटो संग्रह ।
        </p>
      </div>
      ...
      <p className="text-gray-600 mt-12 max-w-3xl">
        थप फोटोहरू चाँडै थपिनेछ । यदि तपाईंलाई कुनै फोटो छुटेको वा थप्नुपर्ने लाग्छ भने सूचना शाखा,
        ज्वालामुखी गाउँपालिका सम्पर्क गर्नुहोस्।
      </p>
    </div>
    <Footer/>
    </>
